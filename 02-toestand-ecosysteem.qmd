...
# Toestand van het ecosysteem {#sec-toestand}
...
**Aanpassen introdcutie - meer focus op metingen en minder overlap met voorgaande**

Planten en dieren kunnen een grote invloed uitoefenen op het ecosysteem. Planten die onder water groeien hebben een belangrijke positieve bijdrage. Kroos, rivierkreeften en blauwalgen kunnen een grote negatieve invloed hebben op het ecosysteem. In dit hoofdstuk wordt de toestand van het ecosysteem beschreven aan de genoemde groepen.
...
In de Krimpenerwaard is het aantal locaties met planten onder water[^01-zichtbare-toestand-1] sinds 2017 sterk afgenomen (@fig-submers). In 2025 was er zelfs geen enkele locatie meer over met enige bedekking van planten onder water. Ook in Schieland neemt het aantal locaties met planten onder water steeds verder af. In Schieland is de afname echter kleiner en minder snel dan in de Krimpenerwaard.
Het is aannemelijk dat de afname van waterplanten komt door de opkomst van Amerikaanse rivierkreeften.
