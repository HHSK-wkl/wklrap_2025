---
lightbox: auto
description: "Rapportage waterkwaliteit van waterschap Hoogheemraadschap van Schieland en de Krimpenerwaard (HHSK) 2025. Dit hoofdstuk gaat over metingen en meetnetten van het waterschap. Welke chemische stoffen en welke biologische soorten worden er in het gebied gemeten. "
---
...
In {{< var rap_jaar >}} zijn er `r n_metingen_fc` chemische metingen uitgevoerd. Bij het onderzoek zijn er `r n_soorten_bio` verschillende soorten planten en dieren waargenomen. 
